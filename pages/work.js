...
function WorkContent({ content }) {
  ...
  const caseStudies = [
    { cat: 'health',    tag: 'Healthcare · Operations', client: 'Nordvale Health',  title: 'Patient journey optimization across 50 hospitals',    desc: 'Redesigned the end-to-end care experience from GP referral to discharge, reducing wait times and standardizing clinical protocols.', s1: '€2.1B', l1: 'Value created',    s2: '31%',  l2: 'Wait time reduction' },
    { cat: 'logistics', tag: 'Logistics · AI',          client: 'Sienna Logistics', title: 'AI-powered supply chain reinvention',                  desc: 'Introduced machine learning across demand forecasting, last-mile routing, and real-time anomaly detection.',                          s1: '3×',    l1: 'Throughput increase', s2: '22%',  l2: 'Cost reduction' },
    { cat: 'banking',   tag: 'Banking · M&A Integration', client: 'Vantage Capital', title: 'Post-merger integration of two rival banks',           desc: 'Led the cultural and operational integration following a $4.2B acquisition, harmonizing two competing technology stacks.',               s1: '6mo',   l1: 'Ahead of synergy plan', s2: '$380M', l2: 'Annual synergies' },
    { cat: 'energy',    tag: 'Energy · Sustainability', client: 'Crestwood Energy', title: 'Net-zero transition roadmap & execution',               desc: 'Designed a 10-year decarbonization strategy for a major integrated oil & gas company entering the renewable energy sector.',             s1: '40%',   l1: 'Emissions reduction Yr1', s2: '£1.2B', l2: 'Renewables investment' },
    { cat: 'tech',      tag: 'Technology · Go-to-Market', client: 'Elara Technologies', title: 'Enterprise SaaS platform market entry',            desc: 'Took an enterprise software product from zero revenue to $120M ARR in 18 months through market positioning redesign.',                 s1: '€120M', l1: 'ARR achieved',        s2: '18mo', l2: 'Zero to scale' },
    { cat: 'health',    tag: 'Pharma · Strategy',       client: 'Orion Pharma',     title: 'Portfolio strategy for rare disease pivot',             desc: 'Advised the board of a mid-sized pharmaceutical firm on a major strategic pivot into orphan drug development.',                          s1: '4',     l1: 'Acquisitions identified', s2: '$2.8B', l2: 'Market cap created' },
  ]
          ...
          <div className="cs-grid">
            {caseStudies.map((cs, i) => (
              <div key={i} className={`cs-card rev d${(i % 3) + 1}${filter !== 'all' && filter !== cs.cat ? ' hidden' : ''}`} data-category={cs.cat}>
                <div className="cs-img"><span className="cs-img-tag">{cs.tag}</span></div>
