...
function WorkContent({ content }) {
  ...
  const caseStudies = [
    ...
    { cat: 'energy',    tag: 'Energy · Sustainability',   client: 'Crestwood Energy',    img: 'https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=900&q=80&auto=format&fit=crop', title: 'Net-zero transition roadmap & execution',               desc: 'Designed a 10-year decarbonization strategy for a major integrated oil & gas company entering the renewable energy sector.',             s1: '40%',   l1: 'Emissions reduction Yr1', s2: '£1.2B', l2: 'Renewables investment' },
